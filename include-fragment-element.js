...
//
// SPDX-License-Identifier: LicenseRef-MIT-include-fragment-element

/* Copied from
	https://github.com/github/include-fragment-element/releases/tag/v5.1.2 */

/* Currently using v5.1.2 instead of the latest version because versions after
	5.1.2 uses typescript and I don't have a good way to deal with that
	currently. Maybe after Haketilo roadmap #16 is finished or Trisquel updates
	the node-typescript package to allow compiling newer TypeScript, we can
